 ...
 */
public class InfosThemeParametre
{	
	 ...
	 */
	public InfosThemeParametre(String id, String nom, int type, String description, boolean optionnel, String dependance, String defaut) {
		this.id = id;
		this.nom = nom;
		this.type = type;
