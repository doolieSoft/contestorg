 ...
 */
public class InfosThemeFichier
{
	// Transformations
	 ...
	 */
	public InfosThemeFichier(String id, String nom, String source, String cible, String transformation, boolean principal, boolean fixe, String description) {
		this.id = id;
		this.nom = nom;
		this.source = source;
		this.cible = cible;
