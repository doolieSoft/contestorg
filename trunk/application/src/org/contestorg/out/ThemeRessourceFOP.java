...
/**
 * Ressource FOP de thème d'exportation/diffusion
 */
public class ThemeRessourceFOP extends ThemeRessourceAbstract
{
	/** Fichier XML */
	private File xml;
	 ...
	 */
	public ThemeRessourceFOP(String cible, boolean principale, HashMap<String,String> parametres, HashMap<String,String> fichiers, File xsl) throws ContestOrgWarningException {
		// Constructeur parent
