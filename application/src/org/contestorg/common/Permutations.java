...
public class Permutations {
	...
	*/
	 ...
	 */
	public static Object[] permutation(int k,Object[] objects) {
		Object[] permutation = objects.clone();
        for (int i=2;i < permutation.length+1;i++) {
            k = k / (i-1);
            Permutations.swap(permutation,k % i,i-1);
        }
        return permutation;
    }
	 ...
	 * @param objects le tableau d'objet
	 * @param indexA le premier index
	 * @param indexB le deuxième index
	 */
